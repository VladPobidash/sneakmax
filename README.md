# Product landing - Sneakmax

Репозиторий для проекта sneakmax с [канала MaxGraph](https://www.youtube.com/playlist?list=PLCMvV-acWe2C6jDUnjs5SgSrgxbAVQu9G)<br>

> Используется Gulp 4. Cпасибо [MaxGraph](https://github.com/maxdenaro) за [сборку](https://github.com/maxdenaro/gulp-maxgraph).
